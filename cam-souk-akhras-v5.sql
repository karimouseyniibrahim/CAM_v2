...
-- Listage des données de la table cam-souk-akhras-v2.filesmedias : ~12 rows (environ)
...
-- Listage des données de la table cam-souk-akhras-v2.logs : ~567 rows (environ)
