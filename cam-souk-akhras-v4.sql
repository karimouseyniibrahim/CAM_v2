...
-- Listage des données de la table cam-souk-akhras-v2.command : ~14 rows (environ)
...
CREATE TABLE IF NOT EXISTS `filesmedias` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `filesmedias_media_id_foreign` (`media_id`),
  CONSTRAINT `filesmedias_media_id_foreign` FOREIGN KEY (`media_id`) REFERENCES `medias` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Listage des données de la table cam-souk-akhras-v2.filesmedias : ~0 rows (environ)
/*!40000 ALTER TABLE `filesmedias` DISABLE KEYS */;
INSERT INTO `filesmedias` (`id`, `url`, `media_id`, `created_at`, `updated_at`) VALUES
	...
	(77, '/files/17/83.jpg', 17, '2019-03-08 23:53:57', '2019-03-08 23:53:57'),
...
INSERT INTO `items` (`id`, `name`, `link`, `type`, `icon`, `parent_id`, `order`, `controller_path`, `menu_id`, `created_at`, `updated_at`) VALUES
	...
	(61, '{"en":"Medias","ar":"Medias"}', 'medias', '', '<i class="fa fa-plus-square-o" aria-hidden="true"></i> ', 0, 46, '["App\\\\Application\\\\Controllers\\\\Admin\\\\MediasController"]', 3, '2019-03-08 13:00:30', '2019-03-08 13:00:30');
...
-- Listage des données de la table cam-souk-akhras-v2.logs : ~598 rows (environ)
...
INSERT INTO `medias` (`id`, `name`, `description`, `type`, `created_at`, `updated_at`) VALUES
	(17, '{"en":"Gestions","ar":"ايقونات الموقع"}', '{"en":"<p>qefvresversvzr<\\/p>","ar":"<p>sdwvedfxc<\\/p>"}', 1, '2019-03-08 23:53:56', '2019-03-08 23:53:56');
...
-- Listage des données de la table cam-souk-akhras-v2.permissions : ~566 rows (environ)
...
-- Listage des données de la table cam-souk-akhras-v2.permission_group : ~296 rows (environ)
