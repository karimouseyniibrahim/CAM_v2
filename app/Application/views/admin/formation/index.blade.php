...
@push('header')
    <button class="btn btn-danger" onclick="deleteThemAll(this)" data-link="{{ url('admin/formation/pluck') }}" ><i class="fa fa-trash"></i></button>
...
@section('content')
    @include(layoutTable() , ['title' => trans('formation.formation') , 'model' => 'formation' , 'table' => $dataTable->table([] , true) ])
@endsection
