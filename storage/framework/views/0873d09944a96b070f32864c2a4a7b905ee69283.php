<?php $__env->startSection('title'); ?>
    <?php echo e(trans('group.group')); ?> <?php echo e(trans('home.control')); ?>
...
<?php $__env->startPush('header'); ?>
    <button class="btn btn-danger" onclick="deleteThemAll(this)" data-link="<?php echo e(url('admin/group/pluck')); ?>" ><i class="fa fa-trash"></i></button>
...
<?php $__env->startPush('search'); ?>
    <form method="get" class="form-inline">
        ...
        <div class="form-group">
            <input type="text" name="name" class="form-control" placeholder="<?php echo e(trans('group.name')); ?>" value="<?php echo e(request()->has('name') ? request()->get('name') : ''); ?>">
        </div>
        <div class="form-group">
            <input type="text" name="slug" class="form-control" placeholder="<?php echo e(trans('group.slug')); ?>" value="<?php echo e(request()->has('slug') ? request()->get('slug') : ''); ?>">
        </div>
        <button class="btn btn-success" type="submit" ><i class="fa fa-search"></i></button>
        <a href="<?php echo e(url('admin/group')); ?>" class="btn btn-danger" ><i class="fa fa-close"></i></a>
    </form>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('content'); ?>
    <?php echo $__env->make(layoutTable(), ['title' =>  trans('group.group'), 'model'=>'group', 'table' => $dataTable->table([] , true) ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
