...
<?php $__env->startPush('header'); ?>
    <button class="btn btn-danger" onclick="deleteThemAll(this)" data-link="<?php echo e(url('admin/local/pluck')); ?>" ><i class="fa fa-trash"></i></button>
...
<?php $__env->startPush('search'); ?>
    <form method="get" class="form-inline">
        ...
        <a href="<?php echo e(url('admin/local')); ?>" class="btn btn-danger" ><i class="fa fa-close"></i></a>
    </form>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('content'); ?>
    <?php echo $__env->make(layoutTable() , ['title' => trans('local.local') , 'model' => 'local' , 'table' => $dataTable->table([] , true) ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
