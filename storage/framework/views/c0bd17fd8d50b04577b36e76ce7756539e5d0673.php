<script>
    ...
    function name() {
        ...
        output += '<div class="form-group name">' +
                '<label for="name"><?php echo e(trans("contact.name")); ?></label>' +
    ...
    function addNewColumn() {
        ...
        output += '<div class="parent clearfix"><div class="row well "><div class="col-lg-6"><div class="form-group col-lg-12">' +
                '<label for="name"><?php echo e(trans("admin.col name")); ?></label>' +
                ' <input type="text" name="colsName[' + count + ']" id="name"  class="form-control" required/>' +
                '</div>';
        output += '<div class="form-group col-lg-5">' +
                '<label for="name"><?php echo e(trans("admin.col type")); ?></label>' +
                '<select name="migration[' + count + ']" class="form-control" required>';
        <?php $__currentLoopData = $migrationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                output += '<option value="<?php echo e($type); ?>"><?php echo e($type); ?></option>';
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                output += '</select>' +
                '</div>';
        output += '<div class="form-group col-lg-6">' +
                '<label for="name"><?php echo e(trans("admin.lang")); ?></label>' +
                '<select name="lang[' + count + ']" class="form-control"><option value="0"><?php echo e(trans("admin.no")); ?></option><option value="1"><?php echo e(trans("admin.yes")); ?></option></select>' +
                '</div>';
        ...
        output += '</div><div class="col-lg-6"><div class="form-group col-lg-12">' +
                '<label for="name"><?php echo e(trans("admin.col validation")); ?></label><div class="row">';
        <?php $__currentLoopData = $validationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>  $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                output += '<div class="col-lg-2 inline-form"><input type="checkbox" name="validation[' + count + '][<?php echo e($key); ?>]" /> <?php echo e($key); ?> </div>';
        <?php if($type): ?>
                output += '<div class="col-lg-10"><input type="text" name="validationVal[' + count + '][<?php echo e($key); ?>]" id="name"  class="form-control"/></div>';
        <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    function appendModels() {
        ...
        output += '<div class="">';
        output += '<label for=""><?php echo e(trans('admin.Select Model')); ?></label>';
        output += '<select name="foreign_key" id="foreign_key" class="form-control" required>';
        <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                output += '<option value="<?php echo e($model); ?>"><?php echo e($model); ?></option>';
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                output += '</select>';
        output += '</div>';
        output += '</div>';
