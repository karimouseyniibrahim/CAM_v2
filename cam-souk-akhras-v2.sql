...
-- Listage des données de la table cam-souk-akhras-v2.command : ~8 rows (environ)
DELETE FROM `command`;
...
-- Listage des données de la table cam-souk-akhras-v2.formation : ~1 rows (environ)
...
-- Listage des données de la table cam-souk-akhras-v2.items : ~45 rows (environ)
DELETE FROM `items`;
...
INSERT INTO `items` (`id`, `name`, `link`, `type`, `icon`, `parent_id`, `order`, `controller_path`, `menu_id`, `created_at`, `updated_at`) VALUES
	...
	(43, '{"en":"Formation","ar":"Formation"}', '/admin/formation', '', '<i class="material-icons">control_point</i>', 0, 35, '["App\\\\Application\\\\Controllers\\\\Admin\\\\FormationController"]', 1, '2019-03-06 14:35:29', '2019-03-06 14:35:29'),
	...
	(45, '{"en":"Inscription","ar":"Inscription"}', '/admin/inscription', '', '<i class="material-icons">control_point</i>', 0, 37, '["App\\\\Application\\\\Controllers\\\\Admin\\\\InscriptionController"]', 1, '2019-03-06 15:09:03', '2019-03-06 15:09:03'),
	(47, '{"en":"Section","ar":"Section"}', '/admin/section', '', '<i class="material-icons">control_point</i>', 0, 38, '["App\\\\Application\\\\Controllers\\\\Admin\\\\SectionController"]', 1, '2019-03-06 20:38:36', '2019-03-06 20:38:36'),
	...
	(49, '{"en":"Local","ar":"Local"}', '/admin/local', '', '<i class="material-icons">control_point</i>', 0, 40, '["App\\\\Application\\\\Controllers\\\\Admin\\\\LocalController"]', 1, '2019-03-06 20:53:21', '2019-03-06 20:53:21'),
	(50, '{"en":"Local","ar":"Local"}', 'local', '', '<i class="fa fa-plus-square-o" aria-hidden="true"></i> ', 0, 41, '["App\\\\Application\\\\Controllers\\\\Admin\\\\LocalController"]', 3, '2019-03-06 20:53:21', '2019-03-06 20:53:21'),
	(51, '{"en":"Artisan","ar":"Artisan"}', '/admin/artisan', '', '<i class="material-icons">control_point</i>', 0, 42, '["App\\\\Application\\\\Controllers\\\\Admin\\\\ArtisanController"]', 1, '2019-03-06 20:55:33', '2019-03-06 20:55:33'),
	(52, '{"en":"Artisan","ar":"Artisan"}', 'artisan', '', '<i class="fa fa-plus-square-o" aria-hidden="true"></i> ', 0, 43, '["App\\\\Application\\\\Controllers\\\\Admin\\\\ArtisanController"]', 3, '2019-03-06 20:55:33', '2019-03-06 20:55:33'),
	(53, '{"en":"Request","ar":"Request"}', '/admin/request', '', '<i class="material-icons">control_point</i>', 0, 44, '["App\\\\Application\\\\Controllers\\\\Admin\\\\RequestController"]', 1, '2019-03-06 23:20:14', '2019-03-06 23:20:14'),
	(54, '{"en":"Request","ar":"Request"}', 'request', '', '<i class="fa fa-plus-square-o" aria-hidden="true"></i> ', 0, 45, '["App\\\\Application\\\\Controllers\\\\Admin\\\\RequestController"]', 3, '2019-03-06 23:20:14', '2019-03-06 23:20:14');
/*!40000 ALTER TABLE `items` ENABLE KEYS */;

-- Listage des données de la table cam-souk-akhras-v2.links : ~2 rows (environ)
DELETE FROM `links`;
...
INSERT INTO `local` (`id`, `name`, `description`, `image`, `price`, `area`, `section_id`, `created_at`, `updated_at`) VALUES
	(1, '{"en":"Local 01","ar":"Local 01"}', '{"en":"<p>Local 01.....<\\/p>","ar":null}', '78808_1551906857.jpg', 14000, 25, 1, '2019-03-06 21:14:17', '2019-03-06 21:14:17'),
...
-- Listage des données de la table cam-souk-akhras-v2.logs : ~167 rows (environ)
DELETE FROM `logs`;
...
-- Listage des données de la table cam-souk-akhras-v2.migrations : ~29 rows (environ)
...
-- Listage des données de la table cam-souk-akhras-v2.permissions : ~251 rows (environ)
...
-- Listage des données de la table cam-souk-akhras-v2.permission_group : ~250 rows (environ)
...
-- Listage des données de la table cam-souk-akhras-v2.request : ~0 rows (environ)
DELETE FROM `request`;
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `group_id`, `api_token`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'admin', 'admin@gmail.com', '$2y$10$L73fIoyiWTHYsJX0iADeaeO7j6qtpYiHgv6ZqKvR7Z3PKy.3UjioW', 1, '6eHhqtVbg0jrHTzu9SksHpbvysuElRsQlXpo3Gz1jnNJMDkIrs6UejkHIkd7', 'OKzu9nG9yypfnSZycwieGW0jzLOeKZViiEhC9xOcN4ZjS7ipKnWFvghApW70', '2019-03-05 19:54:27', '2019-03-05 19:54:27');
